defmodule Ryker.Learning.UsageBackfill do
  @moduledoc """
  ...
  `Ryker.Accounting.observe_learning_in_transaction/6` the live executor uses,
  ...
  alias Ryker.Learning.{Batch, Executor}
  alias Ryker.Repo
  alias Ryker.State.LearningRun
  alias Ryker.Work.{Measurement, Session}
