defmodule Ryker.Work.Session do
  @moduledoc false
  ...
  schema "episode_work_sessions" do
    ...
    field(:workspace_task, Ryker.CanonicalJSON.Type)
    ...
    field(:discard_plan, Ryker.CanonicalJSON.Type)
    field(:discard_plan_fingerprint, :string)
    field(:discard_generation, :integer, default: 1)
    field(:cleanup_receipt, Ryker.CanonicalJSON.Type)
