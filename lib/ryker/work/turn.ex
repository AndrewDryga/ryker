defmodule Ryker.Work.Turn do
  ...
  schema "episode_work_turns" do
    ...
    field(:selection_ledger, Ryker.CanonicalJSON.Type)
    ...
    field(:validation_intent, Ryker.CanonicalJSON.Type)
    field(:validation_intent_fingerprint, :string)
    field(:validation_history, Ryker.CanonicalJSON.Type, default: [])
    field(:validation_receipt, :string)
    field(:completion_receipt, Ryker.CanonicalJSON.Type)
    ...
    field(:cancellation_intent, Ryker.CanonicalJSON.Type)
  ...
  @type t :: %__MODULE__{
          ...
          submission: Ryker.Work.Submission.t() | nil,
          ...
          validation_intent: Ryker.Work.ValidationIntent.t() | nil,
          ...
          cancellation_intent: Ryker.Work.Cancellation.intent() | nil,
