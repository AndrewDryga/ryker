defmodule Ryker.State.MemoryEntry do
  @moduledoc """
  ...
  schema "operational_memory_entries" do
    ...
    field(:scope_kind, Ecto.Enum, values: [:conversation, :repository, :workspace, :global])
    field(:scope_ref, :string)
    field(:visibility, Ecto.Enum, values: [:conversation, :workspace, :global])
    ...
    field(:answer_provenance, Ryker.CanonicalJSON.Type)
