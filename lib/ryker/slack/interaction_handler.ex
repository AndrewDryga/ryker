defmodule Ryker.Slack.InteractionHandler do
  @moduledoc """
  ...
  defp remove_entity(%Interaction{action_id: "ryker_resume_behavior"} = interaction, options) do
  ...
  defp remove_entity(%Interaction{action_id: "ryker_delete_behavior"} = interaction, options) do
    with {:ok, ref, revision} <- versioned_resource(interaction.action_value, "behavior"),
         {:ok, _result} <-
  ...
  defp remove_entity(%Interaction{action_id: "ryker_forget_memory"} = interaction, options) do
    with {:ok, _result} <-
  ...
  defp dispatch_action(
         %Interaction{action_id: "ryker_resume_work"} = interaction,
         work_ref,
  ...
  defp dispatch_action(
         %Interaction{action_id: "ryker_stop_work"} = interaction,
         work_ref,
         nil,
         options
       ) do
  ...
  defp dispatch_action(
         %Interaction{action_id: "ryker_close_work"} = interaction,
         work_ref,
         nil,
         options
       ) do
  ...
  defp dispatch_action(
         %Interaction{action_id: "ryker_task_publish"} = interaction,
         work_ref,
  ...
  defp dispatch_action(
       ...
       when action_id in ~w(ryker_task_retry_publication ryker_task_update_publication ryker_task_discard_publication) do
    attributes =
      interaction
    ...
    action =
      case action_id do
        "ryker_task_retry_publication" -> :retry
        "ryker_task_update_publication" -> :update
        "ryker_task_discard_publication" -> :discard
      end
  ...
  defp dispatch_action(
         %Interaction{action_id: "ryker_publish_draft"} = interaction,
         publication_ref,
         nil,
         options
       ) do
  ...
  defp dispatch_action(
         %Interaction{action_id: "ryker_open_publication"},
         publication_ref,
         nil,
         _options
       ) do
  ...
  defp dispatch_action(
         %Interaction{action_id: "ryker_confirm_memory"} = interaction,
         record_ref,
         nil,
         options
       ) do
  ...
  defp dispatch_action(
         %Interaction{action_id: "ryker_confirm_automation"} = interaction,
         record_ref,
         nil,
         options
       ) do
  ...
  defp dispatch_action(
         %Interaction{action_id: "ryker_confirm_schedule"} = interaction,
         record_ref,
         nil,
         options
       ) do
  ...
  defp dispatch_action(
         %Interaction{action_id: "ryker_confirm_behavior"} = interaction,
         record_ref,
         nil,
         options
       ) do
  ...
  defp apply_action(
         %Interaction{action_id: "ryker_submit_input"},
  ...
  defp apply_action(
         %Interaction{action_id: "ryker_answer_input"} = interaction,
         %{kind: "input_request"},
         choice_index,
         options
       )
  ...
  defp apply_action(
         %Interaction{action_id: "ryker_investigate_incident"} = interaction,
  ...
  defp apply_action(
         %Interaction{action_id: "ryker_review_publication"} = interaction,
  ...
  defp apply_action(
         %Interaction{action_id: "ryker_confirm_slack_post"} = interaction,
  ...
  defp matching_task_action("ryker_start_engineering_task", "engineering"), do: :ok
  defp matching_task_action("ryker_open_incident", "incident"), do: :ok
  ...
  defp selection(%Interaction{action_id: "ryker_resume_work", action_value: action_value}) do
    case String.split(action_value, "|", parts: 2) do
