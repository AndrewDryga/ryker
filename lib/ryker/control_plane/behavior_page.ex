defmodule Ryker.ControlPlane.BehaviorPage do
  ...
  defp empty_help(:standing_assignment),
    do:
      "No confirmed rules are active in this installation. Rules from a previous installation are not enabled here automatically."

  defp empty_help(:preference),
    do: "No confirmed preferences are active. Ryker is using its defaults."

  defp empty_help(:guidance),
    do:
      "No confirmed guidance is active. Ask Ryker to remember an instruction to make it available here."
end
