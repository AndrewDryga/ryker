defmodule Ryker.ControlPlane.Projection do
  ...
  alias Ryker.ControlPlane.{Activity, AdmissionProgress, InspectionRedactor, UsageProjection}
  alias Ryker.ControlPlane.BehaviorLibrary
  alias Ryker.ControlPlane.ChannelDetail
  ...
  alias Ryker.ControlPlane.{Card, EpisodeTrace, LabCursor}
  ...
  alias Ryker.Slack.{IncidentRoom, InteractionAudit, ThreadStatus}
  alias Ryker.State.{Behavior, Memories, MemoryEntry, Record, Schedule}
  ...
  defdelegate channels(params), to: Ryker.ControlPlane.OperatorProjection
  defdelegate incident(ref), to: Ryker.ControlPlane.OperatorProjection
  defdelegate incidents(params), to: Ryker.ControlPlane.OperatorProjection
  defdelegate operator_configuration(), to: Ryker.ControlPlane.OperatorProjection
  defdelegate repositories(params), to: Ryker.ControlPlane.OperatorProjection
  defdelegate schedule(ref), to: Ryker.ControlPlane.OperatorProjection
  defdelegate schedules(params), to: Ryker.ControlPlane.OperatorProjection
  defdelegate subscriptions(params), to: Ryker.ControlPlane.OperatorProjection
  ...
  def usage(params) when is_map(params) do
    ...
    query = Ryker.Accounting.Query.executions(since, mode)
