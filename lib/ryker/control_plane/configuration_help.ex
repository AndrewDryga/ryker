defmodule Ryker.ControlPlane.ConfigurationHelp do
  ...
  @settings %{
    ...
    "state_tools" => {
      "Ryker state tools",
      "Exposes Ryker's durable workflow tools to authorized model sessions.",
  ...
  def grant("host capability"),
    do:
      "A durable workflow feature exposed by Ryker, such as event waits or schedules. Each operation still checks the request's authority."
