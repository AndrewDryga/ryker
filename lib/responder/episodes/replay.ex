defmodule Responder.Episodes.Replay do
  @moduledoc """
  ...
  alias Responder.Episodes.{Kernel, Snapshot}
  ...
  defmodule Result do
    ...
    @type t :: %__MODULE__{
            checkpoints: [map()],
            episode: Responder.Episodes.Episode.t() | nil,
            events: [Responder.Episodes.Event.t()],
            events_by_key: %{optional(String.t()) => Responder.Episodes.Event.t()},
            linked_results: [t()]
          }
  end
