defmodule Responder.Slack.Admission.Decision do
  @moduledoc """
  The complete model-controlled portion of Slack admission.

  Candidate references are opaque values supplied by the host. The decision
  never contains a Slack channel, message timestamp, or raw episode identity.
  """
  ...
  def json_schema do
    %{
      ...
      "oneOf" => decision_shapes(),
      "required" => @fields,
      "title" => "Slack admission decision",
      "type" => "object"
    }
  end

  defp decision_shapes do
    [
