defmodule Responder.CoopFleet.SessionEvidenceDocument do
  @moduledoc """
  ...
  export that drifted cannot become a row Responder then has to interpret.
  ...
  def content_fingerprint(%{} = evidence),
    do: Responder.CanonicalJSON.digest(Map.delete(evidence, "captured_at"))
