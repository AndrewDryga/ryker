defmodule Responder.CoopFleet.Bridge do
  @moduledoc """
  Synchronous Responder-side adapter over durable worker commands.
  ...
  alias Responder.CoopFleet.{Command, ControlPlane, Placement}
