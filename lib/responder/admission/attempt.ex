defmodule Responder.Admission.Attempt do
  @moduledoc false
  use Ecto.Schema
  ...
  schema "admission_attempts" do
    belongs_to(:input, Responder.Ingress.Inbox.Entry)
    ...
    field(:milestones, Responder.CanonicalJSON.Type, default: %{})
    field(:measurements, Responder.CanonicalJSON.Type, default: %{})
    field(:response, Responder.CanonicalJSON.Type)
