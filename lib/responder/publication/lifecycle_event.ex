defmodule Responder.Publication.LifecycleEvent do
  @moduledoc false
  ...
  schema "episode_publication_lifecycle_events" do
    belongs_to(:publication, Responder.Publication.Publication)
    ...
    field(:observation, Responder.CanonicalJSON.Type)
    ...
    field(:delivery_receipt, Responder.CanonicalJSON.Type)
