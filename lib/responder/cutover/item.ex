defmodule Responder.Cutover.Item do
  @moduledoc false
  ...
  schema "responder_cutover_items" do
    belongs_to(:run, Responder.Cutover.Run)
    field(:ref, :string)
    ...
    field(:data, Responder.CanonicalJSON.Type)
    field(:target_refs, Responder.CanonicalJSON.Type)
