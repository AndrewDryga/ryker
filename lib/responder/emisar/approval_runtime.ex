defmodule Responder.Emisar.ApprovalRuntime do
  @moduledoc """
  ...
  alias Responder.Emisar.ApprovalWorker
  ...
  def options!(configuration) do
    ...
    presenter = Map.get(configuration, :presenter, Responder.Emisar.ApprovalPresenter)
