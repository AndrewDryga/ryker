defmodule Responder.ControlPlane.LearningActivity do
  ...
  alias Responder.Learning.{Batch, InputMembership, Runtime}
  ...
  defp retry_reason(:deferred, true, _busy),
    do:
      "An earlier model execution has not been confirmed stopped. Responder must reconcile it before another start."
  ...
  def error("learning_remote_unresolved"),
    do:
      "The model execution may still be running. Responder checks its state again before allowing another start."
