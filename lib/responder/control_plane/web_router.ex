defmodule Responder.ControlPlane.WebRouter do
  ...
  scope "/" do
    ...
    for path <-
          ~w(lab card-lab episodes incidents schedules subscriptions channels repositories failures workspaces decisions findings audit memory calibration usage configuration manual-tests) do
