defmodule Responder.GitHub.Confirmations do
  @moduledoc """
  ...
  alias Responder.State.{Automations, Behaviors, Memories, Record, Schedules, TaskOffers}
  alias Responder.Work.Turn

  @command_prefix "/responder confirm"
  @command ~r/\A\/responder confirm ([A-Za-z0-9_.:-]{1,256})\z/
