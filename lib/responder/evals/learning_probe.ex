defmodule Responder.Evals.LearningProbe do
  @moduledoc """
  ...
  """
  import Ecto.Query
  alias Responder.{Admission, CanonicalJSON, Repo}
  alias Responder.Admission.Decision
  alias Responder.Delivery.Adapters
  alias Responder.Evals.SlackDeliveryPublisher
  alias Responder.Ingress.{Inbox, Input}
  alias Responder.Ingress.Inbox.Entry
  alias Responder.State.{KnowledgeExposure, LearningRun}
  ...
  defp work(settings, left) do
    case Responder.Work.Dispatcher.run_once(
