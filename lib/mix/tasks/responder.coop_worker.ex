defmodule Mix.Tasks.Responder.CoopWorker do
  @moduledoc """
  Manages one Coop worker's enrollment and operator-owned lifecycle.
      ...
      mix responder.coop_worker enroll WORKER_ID WORKSPACE_REF OPERATOR_REF TTL_SECONDS
      mix responder.coop_worker drain WORKER_ID OPERATOR_REF
      mix responder.coop_worker resume WORKER_ID OPERATOR_REF
      mix responder.coop_worker revoke WORKER_ID OPERATOR_REF
  ...
  alias Responder.CoopFleet.{Enrollment, WorkerLifecycle}
  ...
  defp usage! do
    Mix.raise(
      "usage: mix responder.coop_worker enroll WORKER_ID WORKSPACE_REF OPERATOR_REF [TTL_SECONDS] | " <>
        "mix responder.coop_worker drain|resume|revoke WORKER_ID OPERATOR_REF"
    )
  end
