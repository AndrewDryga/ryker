defmodule Responder.State.ObservationsConcurrencyTest do
  ...
  alias Responder.Slack.{ChannelFence, ChannelMembership, Input}
  alias Responder.State.{ConversationObservation, Observations}
