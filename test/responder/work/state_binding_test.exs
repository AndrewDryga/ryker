defmodule Responder.Work.StateBindingTest do
  ...
  test "state-tool authority is exact to one logical turn and one session placement" do
    ...
    for invalid_endpoint <- [
          "http://responder.example/v1/state-tools/mcp",
          "https://responder.example/wrong",
          "https://user@responder.example/v1/state-tools/mcp",
          "https://responder.example/v1/state-tools/mcp?token=leak",
