defmodule Responder.ControlPlane.ReceivedInputCardTest do
  @moduledoc """
  ...
  Responder made of it; showing the second under the first's name told an
  operator that the source had sent fields Responder had actually added.
  """
