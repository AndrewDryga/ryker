defmodule Responder.ControlPlane.RouteMapTest do
  @moduledoc """
  ...
  alias Responder.ControlPlane.{Activity, Endpoint, ModelRequests, Navigation, Updates}
  alias Responder.ControlPlane.{ConversationLab, Projection}
  ...
  test "live invalidation reaches the renamed surfaces a reader is actually on" do
    ...
    {:noreply, pending} =
      Updates.handle_info(
        {:notification, self(), state.reference, "responder_control_plane",
