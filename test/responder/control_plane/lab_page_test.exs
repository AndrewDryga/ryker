defmodule Responder.ControlPlane.LabPageTest do
  ...
  test "a message's inspection link resolves only its own retained execution" do
    ...
    action = %{actor: :responder, episode_ref: "grafana:rule-1:cycle-1", status: :delivered}
    ...
    assert LabPage.inspection_link(%{actor: :responder, status: :delivered, text: "hi"}) == nil
