defmodule Responder.ControlPlane.MemoryPageTest do
  @moduledoc """
  ...
  alias Responder.ControlPlane.{HTML, MemoryPage, Router}
  ...
  test "the route keeps the shell's title and description" do
    ...
    assert page.description =~ "What Responder learned from conversations"
