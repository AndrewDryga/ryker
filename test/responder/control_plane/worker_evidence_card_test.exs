defmodule Responder.ControlPlane.WorkerEvidenceCardTest do
  use Responder.DataCase, async: true

  import Phoenix.LiveViewTest, only: [render_component: 2, rendered_to_string: 1]

  alias Responder.ControlPlane.{EpisodePage, Projection, WorkerEvidenceCard}
  ...
  defp episode_key(session),
    do: Repo.get!(Responder.Episodes.Episode, session.episode_id).key
