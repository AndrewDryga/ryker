defmodule Responder.ControlPlane.IsolatedFailureTest do
  @moduledoc """
  ...
  alias Responder.Work.{ActivityEvent, Custody, Session}
  ...
  test "a malformed delivery document does not erase the rest of the timeline" do
    ...
    Repo.update_all(from(turn in Responder.Work.Turn, where: turn.episode_id == ^episode.id),
