defmodule Responder.ControlPlane.CandidateResponseProjectionTest do
  ...
  alias Responder.Work.{CandidateResponse, Custody, Submission, Turn}
  ...
  test "one bulk response query serves the bounded timeline and never loads a different episode" do
    ...
    :ok =
      :telemetry.attach(handler, [:responder, :repo, :query], &__MODULE__.record_query/4, self())
