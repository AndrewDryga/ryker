defmodule Responder.Publication.FollowupDispatcherTest do
  ...
  test "a due publication is polled and its lifecycle notice is delivered once" do
    ...
    assert_receive {:publication_status_requested, "acme/responder", 91}
  ...
  test "a transient poll failure releases custody with bounded retry state" do
    ...
    followup = Repo.get_by!(Responder.Publication.Followup, publication_id: publication.id)
