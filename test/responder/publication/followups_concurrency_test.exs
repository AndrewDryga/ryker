defmodule Responder.Publication.FollowupsConcurrencyTest do
  ...
  alias Responder.Publication.{Followups, LifecycleEvent, Publication}
  alias Responder.Repo
  alias Responder.Slack.TaskCard
  alias Responder.State.{ConversationObservation, LearningSources, Record, Response}
  ...
  defp feedback_input(suffix) do
    {:ok, input} =
      Input.new(%{
        ...
        destination: %{
          transport: "github",
          conversation_ref: "github:responder-app:octo/feedback-equivalence:pull:74",
          thread_ref: nil
        },
        event_kind: :message,
