defmodule Responder.Emisar.ApprovalDispatcherTest do
  use Responder.DataCase, async: true

  import Ecto.Query

  alias Responder.Emisar.{ApprovalDispatcher, Approvals, RunState}
  ...
  test "a monitor that lost its exact lease cannot publish an approval card" do
    ...
    before_return = fn ->
      Repo.update_all(
        from(approval in Responder.Emisar.Approval,
