defmodule Responder.EpisodesTest do
  use Responder.DataCase, async: true

  alias Responder.Episodes
  alias Responder.Episodes.{EpisodeChangeset, Event, EventChangeset, Reducer}
  ...
  test "the stored canonical command still matches its accepted fingerprint" do
    ...
    Enum.with_index(values, fn payload, index ->
      ...
      assert Responder.CanonicalJSON.digest(stored.payload) == stored.fingerprint
    end)
  end
