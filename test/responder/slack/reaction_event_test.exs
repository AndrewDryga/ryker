defmodule Responder.Slack.ReactionEventTest do
  use ExUnit.Case, async: true

  alias Responder.Slack.ReactionEvent

  @identity %{bot_ref: "B-BOT", bot_user_ref: "U-BOT", workspace_ref: "T123"}

  test "normalizes authenticated feedback on an exact Responder message" do
    assert {:ok, reaction} =
