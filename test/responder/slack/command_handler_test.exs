defmodule Responder.Slack.CommandHandlerTest do
  use ExUnit.Case, async: true

  alias Responder.Slack.{Command, CommandHandler}
  ...
  test "non-operators and non-members are denied before any write" do
    ...
    assert denied["text"] =~ "configured Responder operator"
  ...
  test "the whole emergency command surface remains deterministic and fail closed" do
    ...
    for text <- ["", "help"] do
      ...
      assert response["text"] =~ "Responder emergency kit"
    end
