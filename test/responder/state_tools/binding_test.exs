defmodule Responder.StateTools.BindingTest do
  use Responder.DataCase, async: true

  alias Responder.Episodes
  alias Responder.Fixtures.Episodes, as: EpisodeFixtures
  alias Responder.StateTools.Binding
  alias Responder.Work.{Cancellation, Custody, StateBinding}
  ...
  test "a replacement logical turn cannot be reached with the previous turn bearer" do
    ...
    create_operation_ref =
      "responder:work:create:#{original.session.id}:g#{original.session.create_generation}"
