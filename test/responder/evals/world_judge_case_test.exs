defmodule Responder.Evals.WorldJudgeCaseTest do
  use ExUnit.Case, async: true

  alias Responder.Evals.{WorldCase, WorldJudgeCase}
  ...
  test "compiles a bounded judge case and requires one verdict per rubric criterion" do
    ...
    assert judge.schema["title"] == "Responder model-world quality judgment"
