defmodule Ryker.GitHub.ClientTest do
  ...
  test "reads bounded pull request body discussion reviews threads and changed files" do
    ...
    assert {:ok, %{"items" => [%{"filename" => "lib/ryker.ex"}]}} =
  ...
  test "finds, creates, and verifies exact draft pull requests" do
    ...
    pull = %{
      "base" => %{"ref" => "main"},
      "draft" => true,
      "head" => %{"ref" => "ryker/fix-123", "sha" => sha},
      "html_url" => "https://github.com/octo/example/pull/42",
      "merged" => false,
      "number" => 42,
      "state" => "open",
  ...
  test "reports exact pull request, check-run, and commit-status lifecycle" do
    ...
    pull = %{
      "base" => %{"ref" => "main"},
      "draft" => false,
      "head" => %{"ref" => "ryker/fix-123", "sha" => head_sha},
      "html_url" => "https://github.com/octo/example/pull/42",
  ...
  defp pull_request_document do
    %{
      "base" => %{"ref" => "main"},
      "draft" => true,
      "head" => %{"ref" => "ryker/fix", "sha" => String.duplicate("a", 40)},
      "html_url" => "https://github.com/octo/example/pull/42",
      "merged" => false,
      "number" => 42,
      "state" => "open",
